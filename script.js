...
const translations = {
    fr: {
        ...
        badge_recent: "Récent",
        badge_urgent: "Urgent",
        j1_loc: "Tout le Maroc",
        j1_req: "Bac+2 en Gestion",
        j2_loc: "Déploiement National",
        j2_req: "Permis B / C / D",
        j3_loc: "CHU & Hôpitaux",
        j3_req: "Rigueur & empathie",
        ...
        priv_title: "Politique de Confidentialité & Cookies",
        priv_p1: "Chez PRO C2S, nous accordons une importance majeure à la protection de vos données personnelles conformément à la législation marocaine en vigueur.",
        priv_h2: "1. Utilisation des cookies",
        priv_p2: "Les cookies sont de petits fichiers textes stockés sur votre navigateur pour améliorer votre navigation, mesurer l'audience de notre site web et sécuriser nos services de recrutement.",
        priv_h3: "2. Données collectées",
        priv_p3: "Les informations transmises via nos formulaires de contact ou nos liens WhatsApp (Noms, e-mails, téléphones, CV) sont strictement réservées à notre département RH pour le traitement de vos demandes professionnelles.",
    ...
    en: {
        ...
        badge_urgent: "Urgent",
        j1_loc: "All Morocco",
        j1_req: "Bac+2 in Management",
        j2_loc: "National Deployment",
        j2_req: "License B / C / D",
        j3_loc: "CHU & Hospitals",
        j3_req: "Rigorous & empathetic",
        ...
        t1_text: "\"PRO C2S saved us during an unexpected activity peak. Qualified and operational profiles delegated in less than 48 hours. A true trusted partner!\"",
        t1_auth: "HR Manager, Industrial Sector",
        t2_text: "\"Thanks to PRO C2S, I quickly found a temporary mission with professional monitoring and always respects payment deadlines. Highly recommend!\"",
        ...
        a3: "It's direct: just click on your chosen offer and send your CV via WhatsApp to our dedicated HR team. Processed within 24 hours.",
        q4: "Do you intervene outside the Casablanca-Rabat axis?",
        a4: "Yes, PRO C2S deploys operational teams nationwide: Tangier, Kenitra, Fez, Oujda, Marrakech, Agadir and Southern regions.",
        m_loc: "Location:",
        m_prof: "Profile:",
        m_desc_title: "Job description & Missions:",
        m_apply: "Apply via WhatsApp",
        priv_title: "Privacy Policy & Cookies",
        priv_p1: "At PRO C2S, we attach major importance to the protection of your personal data in accordance with Moroccan legislation.",
        priv_h2: "1. Use of cookies",
        priv_p2: "Cookies are small text files stored on your browser to improve your navigation, measure audience and secure recruitment services.",
        priv_h3: "2. Collected data",
        priv_p3: "Information transmitted via contact forms or WhatsApp links (Names, emails, phones, CVs) are strictly reserved for our HR department.",
        contact_badge: "CONTACT",
    ...
    ar: {
        ...
        badge_urgent: "عاجل",
        j1_loc: "كل المغرب",
        j1_req: "باك+2 في التسيير",
        j2_loc: "انتشار وطني",
        j2_req: "رخصة السياقة ب / ج / د",
        j3_loc: "المستشفيات الجامعية",
        j3_req: "دقة وتعاطف",
        ...
        q3: "كيف يمكن للمرشح التقدم بطلب لمهمة؟",
        a3: "الأمر فوري: يكفي النقر على العرض وإرسال سيرتك الذاتية عبر واتساب لفريقنا المختص.",
        q4: "هل تدخلون خارج محور الدار البيضاء-الرباط؟",
        a4: "نعم، تنشر PRO C2S فرقا تشغيلية في جميع أنحاء التراب الوطني: طنجة، القنيطرة، فاس، وجدة، مراكش، أكادير.",
        m_loc: "المكان:",
        m_prof: "الملف:",
        m_desc_title: "وصف الوظيفة والمهام:",
        m_apply: "التقدم عبر واتساب",
        priv_title: "سياسة الخصوصية وملفات تعريف الارتباط",
        priv_p1: "في PRO C2S، نولي أهمية كبرى لحماية بياناتك الشخصية وفقاً للتشريعات المغربية المعمول بها.",
        priv_h2: "1. استخدام ملفات تعريف الارتباط",
        priv_p2: "هي ملفات نصية صغيرة مخزنة على متصفحك لتحسين تصفحك وقياس زوار الموقع.",
        priv_h3: "2. البيانات المجمعة",
        priv_p3: "المعلومات المرسلة عبر نماذج الاتصال أو واتساب مخصصة حصرياً لقسم الموارد البشرية لديناميات العمل.",
    ...
    if(contactForm) {
        ...
        contactForm.addEventListener("submit", function(event) {
            ...
            emailjs.sendForm("service_d9cvkm8", "template_ob7d4cb", this)
                .then(() => {
                    const currentLang = localStorage.getItem("proC2s_lang") || "fr";
                    showToast(translations[currentLang].toast_success);
                    contactForm.reset();
                })
                .catch((error) => {
                    console.error("Erreur EmailJS:", error);
                    showToast("Erreur / Error", true);
                })
                .finally(() => {
