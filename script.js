/* ==========================================
   PRO C.2.S - SCRIPT.JS COMPLET (Pro & Fix)
========================================== */

document.addEventListener("DOMContentLoaded", function() {
    // 1. Navigation Active Scroll & Shadow
    ...
    // 3. Cookie Banner Logic (100% Fonctionnel)
    ...
    // 4. Modal Politique de Confidentialité
    ...
    function togglePrivacyModal(e) {
        ...
        if(privacyModal) {
            privacyModal.classList.toggle("open");
        }
    }
